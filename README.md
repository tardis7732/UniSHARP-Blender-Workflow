...
## Local Blender and Unreal workflow

The local single-image Blender GUI, portable Windows setup, output-file conventions,
and Unreal Gaussian Splat PLY importer setup are documented in
[docs/LOCAL_BLENDER_UNREAL_GUIDE.md](docs/LOCAL_BLENDER_UNREAL_GUIDE.md).
